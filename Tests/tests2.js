...
describe("Tests for LinkedList", function () {
  ...
  describe("Tests for function map", function () {
    it("without args, returns new arraylist, it is equal to our arraylist", function () {
      objL.clear();
      objL.push(2)
      objL.push(60)
      let b = objL.map();
      assert.deepEqual(objL.toString(), b.toString());
    });
    it("with args(function that returns element+index, returns new arraylist,", function () {
      objL.clear();
      objL.push(2)
      objL.push(30)
      objL.push(40)
      const b = objL.map(function (a, b) {
        return a + b
      });
      assert.deepEqual('2, 31, 42', b.toString());
    });
  });
  describe("Tests for function reduce", function () {
    it("without args, returns 0", function () {
      objL.clear();
      objL.push(2)
      objL.push(60)
      assert.deepEqual(0, objL.reduce());
    });
    it("with arg = function, returns result of fuction", function () {
      objL.clear();
      objL.push(2)
      objL.push(5)
      objL.push(3)
      ...
      assert.deepEqual(11, objL.reduce((sum, item) => sum + item));
    });
    it("with args = function, initValue , returns result of fuction", function () {
      objL.clear();
      objL.push(2)
      objL.push(5)
      objL.push(3)
      ...
      assert.deepEqual(20, objL.reduce(((sum, item) => sum + item), 9));
    });
  });
  describe("Tests for function reverse", function () {
    it("without args, returns reversed arraylist", function () {
      objL.clear();
      objL.push(2)
      objL.push(3)
      objL.push(4)
      objL.push(5)
      assert.deepEqual('5, 4, 3, 2', objL.reverse().toString());
    });
  });
});